...
public class ProgressRing : Control
{
	...
	static ProgressRing()
	{
		...
		IsActiveProperty = DependencyProperty.Register("IsActive", typeof(bool), typeof(ProgressRing), new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.BindsTwoWayByDefault, IsActiveChanged));
	...
	public ProgressRing()
	{
		...
		{
			Source = new Uri("pack://application:,,,/Spotnet;component/Style/ProgressRingStyle.xaml", UriKind.Absolute)
		});
	...
	{
		MaxSideLength = ((width < 16.0) ? 16.0 : width);
	}

	private void SetEllipseDiameter(double width)
	{
		EllipseDiameter = ((width > 24.0) ? (width / 8.0) : 3.0);
	}
